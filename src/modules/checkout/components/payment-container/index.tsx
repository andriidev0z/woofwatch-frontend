...
import PaymentAirwallex from "../payment-airwallex"
import PaymentStripe from "../payment-stripe"
import PaymentTest from "../payment-test"
import PaymentMxc from "../payment-mxc"
...
const PaymentInfoMap: Record<string, { title: string; description: string }> = {
  ...
  airwallex: {
    title: "Airwallex",
    description: "Secure payment with  Airwallex",
  },
  "mxc-erc20": {
    title: "MXC ERC20",
    description: "Secure payment in crypto",
  },
}
